...
exports.handler = async (event) => {
    ...
    const { title, description, actors, directors, genre } = JSON.parse(event.body);
    ...
    if (genre) {
        filterExpressions.push("contains(#lowerGenres, :lowerGenres)");
        expressionAttributeNames["#lowerGenres"] = "LowerGenres";
        expressionAttributeValues[":lowerGenres"] = genres.toLowerCase();
    }
